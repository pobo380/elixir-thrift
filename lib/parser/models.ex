...
defmodule Thrift.Parser.Models do
  ...
  defmodule Constant do
    ...
    @spec new([%Comment{}, ...], charlist, Literals.t(), Types.t()) :: %Constant{}
  ...
  defmodule TEnum do
    ...
    @type t :: %TEnum{
            comments: [%Comment{}],
            name: String.t(),
            values: %{String.t() => enum_value}
          }
    defstruct comments: [], name: nil, values: []

    import Thrift.Parser.Conversions

    @spec new([%Comment{}, ...], charlist, %{charlist => enum_value}) :: %TEnum{}
  ...
  defmodule Field do
    ...
    @spec new([%Comment{}, ...], integer, boolean, Types.t(), charlist, Literals.t()) :: %Field{}
  ...
  defmodule Exception do
    ...
    @spec new([%Comment{}, ...], charlist, [%Field{}, ...]) :: %Exception{}
  ...
  defmodule Struct do
    ...
    @spec new([%Comment{}, ...], charlist, [%Field{}, ...]) :: %Struct{}
    def new(comments, name, fields) do
  ...
  defmodule Union do
    ...
    @spec new([%Comment{}, ...], charlist, [%Field{}, ...]) :: %Union{}
    def new(comments, name, fields) do
      name = atomify(name)
  ...
  defmodule Function do
    ...
    @spec new([%Comment{}, ...], boolean, Types.t(), charlist, [%Field{}, ...], [
            %Exception{},
            ...
          ]) :: %Function{}
  ...
  defmodule Service do
    ...
    @spec new([%Comment{}, ...], charlist, [%Function{}, ...], charlist) :: %Service{}
    def new(comments, name, functions, extends) do
      %Service{
        comments: comments,
        name: atomify(name),
        extends: atomify(extends),
        functions: functions
      }
    end
  end
  ...
  defmodule Schema do
    ...
    @type definition ::
            %Service{} | %TEnum{} | %Exception{} | %Union{} | %Struct{} | %Constant{} | typedef
    ...
    alias Thrift.Parser.Models.{Constant, Exception, Include, Namespace, Struct, TEnum, Union}
